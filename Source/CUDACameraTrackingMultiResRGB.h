...
class CUDACameraTrackingMultiResRGB
{
public:

	CUDACameraTrackingMultiResRGB(unsigned int imageWidth, unsigned int imageHeight, unsigned int levels);
	~CUDACameraTrackingMultiResRGB();
...
private:
	...
	void renderCorrespondence(CameraTrackingInput cameraTrackingInput, Eigen::Matrix4f& deltaTransform, unsigned int level, CameraTrackingParameters cameraTrackingParameters, const mat4f& intrinsic, const DepthCameraData& depthCameraData );
	...
	CUDABuildLinearSystemRGB* m_CUDABuildLinearSystem;
